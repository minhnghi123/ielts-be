...
export class ImportTestService {
    ...
    async importFromBuffer(
        ...
        const stats = {
            ...
            questions: parsed.sections.reduce((acc, s) => acc + s.questions.length, 0),
    ...
    private async persist(parsed: ParsedTest, opts: ImportTestOptions): Promise<string> {
        ...
        try {
         ...
         VALUES ($1, $2, $3, $4, $5, NOW())`,
                [testId, parsed.skill, parsed.title, parsed.isMock, opts.adminProfileId],
            );
           ...
           VALUES ($1, $2, $3, $4, $5, $6)`,
                    [sectionId, testId, sec.sectionOrder, sec.passage ?? null, audioUrl, sec.timeLimit ?? null],
                );
             ...
             VALUES ($1, $2, $3, $4)`,
                        [uuidv4(), questionId, q.answer.correctAnswers, q.answer.caseSensitive],
                    );
                }
            }
